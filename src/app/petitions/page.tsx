...
import PetitionsListClient from "./PetitionsListClient";

// Đảm bảo trang luôn lấy dữ liệu mới nhất (không cache tĩnh)
export const revalidate = 0;

export default async function PetitionsListPage() {
  ...
  return (
    <div>
      <PetitionsListClient initialPetitions={serializedPetitions} />
    </div>
  );
}
